    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          // echo $this->Form->control('teachers_id', ['label' => 'Professor','empty' => 'Selecione uma disciplina','options' => $teachers]);
          ?>
          <div class="select-2">
            <div class="select-teacher">
              <label for="teachers_id">Professor</label>
              <select name="teachers_id" class="select2-teachers" 
              data-validity-message="Campo obrigatório" oninvalid="this.setCustomValidity(''); 
              if (!this.value) this.setCustomValidity(this.dataset.validityMessage)" 
              oninput="this.setCustomValidity('')" id="teachers_id" required>
